...
def get_time_words_attention_alpha(update_token_index, num_steps,
                                   cross_replace_steps,
    ...
    alpha_time_words = torch.zeros(num_steps + 1, len(update_token_index), max_num_words)
    for i in range(len(update_token_index)):
    ...
    alpha_time_words = alpha_time_words.reshape(num_steps + 1, len(update_token_index), 1, 1, max_num_words)
