...
try:
    ...
    _import_structure["pipeline_stable_diffusion_3_inpaint_adapter"] = ["StableDiffusion3InpaintPipeline_Adapter"]
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_3_inpaint_adapter import StableDiffusion3InpaintPipeline_Adapter
else:
    import sys
