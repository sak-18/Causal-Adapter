...
try:
    ...
    _import_structure["pipeline_causal_controlnet"] = ["StableDiffusionCausalControlNetPipeline"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_causal_controlnet import StableDiffusionCausalControlNetPipeline
