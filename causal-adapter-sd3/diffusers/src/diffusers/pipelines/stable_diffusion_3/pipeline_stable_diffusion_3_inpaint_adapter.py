...
from ...models.controlnets.controlnet_sd3_causal import Causal_SD3ControlNetModel
...
class StableDiffusion3InpaintPipeline_Adapter(DiffusionPipeline, SD3LoraLoaderMixin, FromSingleFileMixin, SD3IPAdapterMixin):
    r"""
    Args:
    ...
    def __init__(
        ...
        if isinstance(controlnet, Causal_SD3ControlNetModel):
    ...
    def __call__(
        ...
        controlnet_config = (
            ...
            if isinstance(self.controlnet, Causal_SD3ControlNetModel)
        ...
        '''for random latent generation, not set the scheduler_kwargs, seems used for inverse based edting'''
        '''image+noise, will need such schduler'''
        ...
        for i in range(len(timesteps)):
            ...
            controlnet_keep.append(keeps[0] if isinstance(self.controlnet, Causal_SD3ControlNetModel) else keeps)
