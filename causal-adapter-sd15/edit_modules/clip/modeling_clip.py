...
class CLIPTextEmbeddings(nn.Module):
    def __init__(self, config: CLIPTextConfig):
        ...
        self.embed_control = None
    
    def set_embedding_manager(self, embedding_manager):
        self.embedding_manager = embedding_manager
    def set_embed_control(self,embed_control_manager):
        self.embed_control = embed_control_manager
    def forward(
        self,
        ...
        if self.embed_control is not None and attribute_cond is not None:
            inputs_embeds = self.embed_control(input_ids,inputs_embeds,attribute_cond)
...
class CLIPTextTransformer(nn.Module):
    ...
    def forward(
        ...
        #input_ids is token_id,position_id is none
        hidden_states = self.embeddings(input_ids=input_ids, position_ids=position_ids,attribute_cond=attribute_cond)
