...
def log_validation(text_encoder, tokenizer, unet, vae, args, accelerator, weight_dtype, epoch):
    ...
    images = pipeline(args.validation_prompt, num_inference_steps=100, generator=generator,guidance_scale=10,num_images_per_prompt=args.num_validation_images,height=args.resolution,width=args.resolution).images
    #     with autocast_ctx:
...
def main():
    ...
    args.output_dir = os.path.join('./logs',now+args.output_dir)
