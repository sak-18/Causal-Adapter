from dagma.locally_connected import LocallyConnected
import torch
...
class DagmaMLP(nn.Module): 
    ...
    def forward(self, x: torch.Tensor,emb:torch.Tensor) -> torch.Tensor:  # [n, d] -> [n, d]
        r"""
...
class DagmaNonlinear:
    ...
    def minimize(self, 
        ...
        for i in range(max_iter):
            ...
            if h_val.item() < 0:
                ...
                return False
            X_hat = self.model(self.X,self.embed)
    ...
    def fit(self, 
        ...
        self.embed = embeddings.type(self.dtype)
